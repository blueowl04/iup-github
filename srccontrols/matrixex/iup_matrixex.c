...
static void iMatrixExSetClassUpdate(Iclass* ic)
{
  ...
  else if (iupStrEqualNoCase(IupGetGlobal("LANGUAGE"), "CZECH"))
  {
    ...
    IupSetLanguageString("IUP_SETTINGSDLG", "Nastavení...");
    IupSetLanguageString("IUP_TEXTSEPARATOR", "Oddelovac císel:");
    IupSetLanguageString("IUP_OTHERTEXTSEPARATOR", "Dalsí oddelovac císel:");
    IupSetLanguageString("IUP_DECIMALSYMBOL", "Desetinný symbol:");
    ...
    IupSetLanguageString("IUP_CURRENTSTATE", "Aktuální stav");
    IupSetLanguageString("IUP_CUTAC", "Vyjmout\tCtrl+X");
    IupSetLanguageString("IUP_COPYAC", "Kopírovat\tCtrl+C");
    ...
    IupSetLanguageString("IUP_FINDDLG", "Najít...\tCtrl+F");
    IupSetLanguageString("IUP_GOTODLG", "Jít na...\tCtrl+G");
    ...
    IupSetLanguageString("IUP_COPYTOSAMECOLUMN", "Kopírovat do (stejný sloupec)");
    IupSetLanguageString("IUP_ALLLINES", "Vsech rádku");
    ...
    IupSetLanguageString("IUP_SELECTEDLINES", "Vybrat rádky");

    IupSetLanguageString("IUP_VISIBILITY", "Viditelnost");
    IupSetLanguageString("IUP_HIDECOLUMN", "Skrýt sloupec");
    IupSetLanguageString("IUP_SHOWHIDDENCOLUMNS", "Zobrazit skryté sloupce");
    IupSetLanguageString("IUP_HIDELINE", "Skrýt rádek");
    IupSetLanguageString("IUP_SHOWHIDDENLINES", "Zobrazit skryté rádky");

    IupSetLanguageString("IUP_COPYTOINTERVAL", "Kopírovat do - rozsah");
    IupSetLanguageString("IUP_GOTO", "Jít na");
    IupSetLanguageString("IUP_LINE", "Rádek:");
    IupSetLanguageString("IUP_COLUMN", "Sloupec:");
    IupSetLanguageString("IUP_LINESTART", "Pocátecní rádek:");
    IupSetLanguageString("IUP_LINEEND", "Koncový rádek:");

    IupSetLanguageString("IUP_UNITS", "Jednotky:");
    IupSetLanguageString("IUP_DECIMALS", "Desetinná místa:");
    IupSetLanguageString("IUP_COLUMNDECIMALS", "Desetinná místa sloupce");
    IupSetLanguageString("IUP_COLUMNDECIMALSDLG", "Desetinná místa sloupce...");
    IupSetLanguageString("IUP_COLUMNUNITS", "Jednotky sloupce");
    IupSetLanguageString("IUP_COLUMNUNITSDLG", "Jednotky sloupce...");

    IupSetLanguageString("IUP_ERRORINVALIDSELECTION", "Neplatný výber.");
    IupSetLanguageString("IUP_ERRORNOTEXT", "Prázdný text.");
    IupSetLanguageString("IUP_ERRORINVALIDDATA", "Neplatná data.");
    IupSetLanguageString("IUP_ERRORNOSELECTION", "Prazdný výber.");
    IupSetLanguageString("IUP_ERRORINVALIDINTERVAL", "Neplatný rozsah.");

    if (IupGetInt(NULL, "UTF8MODE"))
    {
      /* When seeing this file assuming ISO8859-1 encoding, above will appear correct.
      When seeing this file assuming UTF-8 encoding, bellow will appear correct. */
      IupSetLanguageString("IUP_SETTINGSDLG", "NastavenÃ­...");
      IupSetLanguageString("IUP_TEXTSEPARATOR", "OddÄ›lovaÄ ÄÃ­sel:");
      IupSetLanguageString("IUP_OTHERTEXTSEPARATOR", "DalÅ¡Ã­ oddÄ›lovaÄ ÄÃ­sel:");
      IupSetLanguageString("IUP_DECIMALSYMBOL", "DesetinnÃ½ symbol:");
      IupSetLanguageString("IUP_UNDOAC", "ZpÄ›t\tCtrl+Z");
      IupSetLanguageString("IUP_UNDOLISTDLG", "Historie zmÄ›n...\tCtrl+U");
      IupSetLanguageString("IUP_UNDOLIST", "Historie zmÄ›n");
      IupSetLanguageString("IUP_CURRENTSTATE", "AktuÃ¡lnÃ­ stav");
      IupSetLanguageString("IUP_COPYAC", "KopÃ­rovat\tCtrl+C");
      IupSetLanguageString("IUP_PASTEAC", "VloÅ¾it\tCtrl+V");
      IupSetLanguageString("IUP_SELECTALLAC", "Vybrat vÅ¡e\tCtrl+A");
      IupSetLanguageString("IUP_FINDDLG", "NajÃ­t...\tCtrl+F");
      IupSetLanguageString("IUP_GOTODLG", "JÃ­t na...\tCtrl+G");
      IupSetLanguageString("IUP_SORTDLG", "SeÅ™adit...");
      IupSetLanguageString("IUP_COPYTOSAMECOLUMN", "KopÃ­rovat do (stejnÃ½ sloupec)");
      IupSetLanguageString("IUP_ALLLINES", "VÅ¡ech Å™Ã¡dku");
      IupSetLanguageString("IUP_HERETOBOTTOM", "Odtud dolÅ¯");
      IupSetLanguageString("IUP_SELECTEDLINES", "Vybrat Å™Ã¡dky");

      IupSetLanguageString("IUP_HIDECOLUMN", "SkrÃ½t sloupec");
      IupSetLanguageString("IUP_SHOWHIDDENCOLUMNS", "Zobrazit skrytÃ© sloupce");
      IupSetLanguageString("IUP_HIDELINE", "SkrÃ½t Å™Ã¡dek");
      IupSetLanguageString("IUP_SHOWHIDDENLINES", "Zobrazit skrytÃ© Å™Ã¡dky");

      IupSetLanguageString("IUP_COPYTOINTERVAL", "KopÃ­rovat do - rozsah");
      IupSetLanguageString("IUP_GOTO", "JÃ­t na");
      IupSetLanguageString("IUP_LINE", "Å˜Ã¡dek:");
      IupSetLanguageString("IUP_LINESTART", "PoÄÃ¡teÄnÃ­ Å™Ã¡dek:");
      IupSetLanguageString("IUP_LINEEND", "KoncovÃ½ Å™Ã¡dek:");

      IupSetLanguageString("IUP_DECIMALS", "DesetinnÃ¡ mÃ­sta:");
      IupSetLanguageString("IUP_COLUMNDECIMALS", "DesetinnÃ¡ mÃ­sta sloupce");
      IupSetLanguageString("IUP_COLUMNDECIMALSDLG", "DesetinnÃ¡ mÃ­sta sloupce...");

      IupSetLanguageString("IUP_ERRORINVALIDSELECTION", "NeplatnÃ½ vÃ½bÄ›r.");
      IupSetLanguageString("IUP_ERRORNOTEXT", "PrÃ¡zdnÃ½ text.");
      IupSetLanguageString("IUP_ERRORINVALIDDATA", "NeplatnÃ¡ data.");
      IupSetLanguageString("IUP_ERRORNOSELECTION", "PrÃ¡zdnÃ½ vÃ½bÄ›r.");
      IupSetLanguageString("IUP_ERRORINVALIDINTERVAL", "NeplatnÃ½ rozsah.");
    }
  }
