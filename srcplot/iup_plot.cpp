...
static void iPlotSetClassUpdate(Iclass* ic)
{
  ...
  else if (iupStrEqualNoCase(IupGetGlobal("LANGUAGE"), "CZECH"))
  {
    ...
    IupSetLanguageString("IUP_COPY", "Kopírovat");
    IupSetLanguageString("IUP_PRINTDLG", "Tisk...");

    IupSetLanguageString("IUP_ZOOMINAC", "Priblízit\t+");
    IupSetLanguageString("IUP_ZOOMOUTAC", "Oddálit\t-");
    IupSetLanguageString("IUP_RESETZOOMAC", "Zobrazení 1:1\t.");
    IupSetLanguageString("IUP_SHOWHIDELEGEND", "Zobrazit/skrýt legendu");
    IupSetLanguageString("IUP_SHOWHIDEGRID", "Zobrazit/skrýt mrízku");

    IupSetLanguageString("IUP_ERRORINVALIDFORMULA", "Neplatný vzorec.");

    IupSetLanguageString("IUP_PROPERTIESDLG", "Vlastnosti...");
    IupSetLanguageString("IUP_DATASETPROPERTIESDLG", "Vlastnosti datové sady...");
    IupSetLanguageString("IUP_DATASETVALUESDLG", "Hodnoty datové sady...");

    IupSetLanguageString("IUP_NAME", "Název:");
    IupSetLanguageString("IUP_COLOR", "Barva:");
    IupSetLanguageString("IUP_MODE", "Mód");
    IupSetLanguageString("IUP_LINES", "Cáry");
    IupSetLanguageString("IUP_MARKS", "Znacky");
    IupSetLanguageString("IUP_MARKSLINES", "Znacky a cáry");
    ...
    IupSetLanguageString("IUP_HORIZONTALBARS", "Podélné sloupce");
    IupSetLanguageString("IUP_MULTIBARS", "Vícenásobné sloupce");
    IupSetLanguageString("IUP_ERRORBARS", "Chybové sloupce");
    IupSetLanguageString("IUP_STEPS", "Kroky");
    IupSetLanguageString("IUP_PIE", "Kolác");
    IupSetLanguageString("IUP_LINESTYLE", "Styl cáry:");
    IupSetLanguageString("IUP_CONTINUOUS", "Souvislá");
    IupSetLanguageString("IUP_DASHED", "Cárkovaná");
    IupSetLanguageString("IUP_DOTTED", "Teckovaná");
    IupSetLanguageString("IUP_DASH_DOT", "Cárka, tecka");
    IupSetLanguageString("IUP_DASH_DOT_DOT", "Cárka, tecka, tecka");
    IupSetLanguageString("IUP_LINEWIDTH", "Sírka cáry:");
    IupSetLanguageString("IUP_MARKSTYLE", "Styl znacky:");
    IupSetLanguageString("IUP_BAROUTLINE", "Obrys sloupce:");
    IupSetLanguageString("IUP_BARSPACING", "Vzdálenost mezi sloupci:");
    ...
    IupSetLanguageString("IUP_HOLLOW_CIRCLE", "Prázdný krouzek");
    IupSetLanguageString("IUP_HOLLOW_BOX", "Prázdný ctverecek");
    IupSetLanguageString("IUP_HOLLOW_DIAMOND", "Prázdný diamant");
    IupSetLanguageString("IUP_MARKSIZE", "Velikost znacky:");
    IupSetLanguageString("IUP_AREATRANSPARENCY", "Pruhlednost plochy:");
    IupSetLanguageString("IUP_PIERADIUS", "Polomer koláce:");
    IupSetLanguageString("IUP_PIESTARTANGLE", "Uhel pocátku koláce:");
    IupSetLanguageString("IUP_PIECONTOUR", "Obrys koláce:");
    IupSetLanguageString("IUP_PIEHOLE", "Otvor v koláci:");
    IupSetLanguageString("IUP_PIESLICELABEL", "Popis dílu koláce:");
    IupSetLanguageString("IUP_PIESLICELABELPOS", "Pozice popisku dílu koláce:");
    IupSetLanguageString("IUP_PERCENT", "Procenta");
    IupSetLanguageString("IUP_NONE", "Nic");

    IupSetLanguageString("IUP_CLOSE", "Zavrít");

    IupSetLanguageString("IUP_BACKGROUND", "Pozadí");
    IupSetLanguageString("IUP_TITLE", "Název");
    IupSetLanguageString("IUP_LEGEND", "Legenda");
    IupSetLanguageString("IUP_LEGENDBOX", "Rámecek legendy");
    IupSetLanguageString("IUP_BOX", "Ohranicení");
    IupSetLanguageString("IUP_GRID", "Mrízka");
    IupSetLanguageString("IUP_GRIDMINOR", "Sekundární mrízka");
    IupSetLanguageString("IUP_XAXIS", "Osa X");
    IupSetLanguageString("IUP_YAXIS", "Osa Y");
    IupSetLanguageString("IUP_AXISLABEL", "Popis osy");
    IupSetLanguageString("IUP_AXISTICKS", "Dílky osy");
    IupSetLanguageString("IUP_AXISTICKSNUMBER", "Císla dílku osy");
    ...
    IupSetLanguageString("IUP_CHANGESNOTAPPLIEDAPPLY", "Zmeny nebyly provedeny. Provést?");

    IupSetLanguageString("IUP_MARGIN", "Okraj");
    IupSetLanguageString("IUP_LEFT", "Levý:");
    IupSetLanguageString("IUP_RIGHT", "Pravý:");
    IupSetLanguageString("IUP_TOP", "Nahore:");
    IupSetLanguageString("IUP_BOTTOM", "Dole:");

    IupSetLanguageString("IUP_FONTSTYLE", "Styl písma:");
    IupSetLanguageString("IUP_FONTSIZE", "Velikost písma:");
    IupSetLanguageString("IUP_PLAIN", "Obycejné");
    IupSetLanguageString("IUP_BOLD", "Tucné");
    IupSetLanguageString("IUP_ITALIC", "Kurzíva");
    IupSetLanguageString("IUP_BOLDITALIC", "Tucná kurzíva");
    ...
    IupSetLanguageString("IUP_MIN", "Min:");
    IupSetLanguageString("IUP_MAX", "Max:");
    IupSetLanguageString("IUP_REVERSE", "Obrácene:");
    IupSetLanguageString("IUP_CROSSORIGIN", "Pocátek kríze:");
    IupSetLanguageString("IUP_CENTERED", "Centrovane:");

    IupSetLanguageString("IUP_SCALE", "Merítko:");
    IupSetLanguageString("IUP_LINEAR", "Lineární");
    IupSetLanguageString("IUP_LOG10", "Logaritmické (základ 10)");
    IupSetLanguageString("IUP_LOG2", "Logaritmické (základ 2)");
    IupSetLanguageString("IUP_LOGN", "Logaritmické (základ e)");

    IupSetLanguageString("IUP_SPACING", "Vzdálenost:");
    IupSetLanguageString("IUP_MAJORSPAN", "Hlavní rozsah:");
    IupSetLanguageString("IUP_MINORDIVISION", "Vedlejsí rozsah:");
    IupSetLanguageString("IUP_SIZE", "Velikost:");
    IupSetLanguageString("IUP_MAJOR", "Hlavní:");
    IupSetLanguageString("IUP_MINOR", "Vedlejsí:");

    IupSetLanguageString("IUP_ROTATE", "Otocit:");
    IupSetLanguageString("IUP_ANGLE", "Úhel:");

    IupSetLanguageString("IUP_VALUE", "Hodnota:");
    IupSetLanguageString("IUP_DECIMALS", "Desetiny:");
    IupSetLanguageString("IUP_FORMAT", "Formát:");
    ...
    if (IupGetInt(NULL, "UTF8MODE"))
    {
      ...
      When seeing this file assuming UTF-8 encoding, bellow will appear correct. */
      IupSetLanguageString("IUP_EXPORT", "Exportovat");
      IupSetLanguageString("IUP_COPY", "KopÃ­rovat");
      IupSetLanguageString("IUP_PRINTDLG", "Tisk...");

      IupSetLanguageString("IUP_ZOOMINAC", "PÅ™iblÃ­Å¾it\t+");
      IupSetLanguageString("IUP_ZOOMOUTAC", "OddÃ¡lit\t-");
      IupSetLanguageString("IUP_RESETZOOMAC", "ZobrazenÃ­ 1:1\t.");
      IupSetLanguageString("IUP_SHOWHIDELEGEND", "Zobrazit/skrÃ½t legendu");
      IupSetLanguageString("IUP_SHOWHIDEGRID", "Zobrazit/skrÃ½t mÅ™Ã­Å¾ku");

      IupSetLanguageString("IUP_ERRORINVALIDFORMULA", "NeplatnÃ½ vzorec.");

      IupSetLanguageString("IUP_PROPERTIESDLG", "Vlastnosti...");
      IupSetLanguageString("IUP_DATASETPROPERTIESDLG", "Vlastnosti datovÃ© sady...");
      IupSetLanguageString("IUP_DATASETVALUESDLG", "Hodnoty datovÃ© sady...");

      IupSetLanguageString("IUP_NAME", "NÃ¡zev:");
      IupSetLanguageString("IUP_COLOR", "Barva:");
      IupSetLanguageString("IUP_MODE", "MÃ³d");
      IupSetLanguageString("IUP_LINES", "ÄŒÃ¡ry");
      IupSetLanguageString("IUP_MARKS", "ZnaÄky");
      IupSetLanguageString("IUP_MARKSLINES", "ZnaÄky a ÄÃ¡ry");
      IupSetLanguageString("IUP_BARS", "Sloupce");
      IupSetLanguageString("IUP_AREA", "Plocha");
      IupSetLanguageString("IUP_STEMS", "Stonky");
      IupSetLanguageString("IUP_MARKSSTEMS", "ZnaÄky & stonky");
      IupSetLanguageString("IUP_HORIZONTALBARS", "PodÃ©lnÃ© sloupce");
      IupSetLanguageString("IUP_MULTIBARS", "VÃ­cenÃ¡sobnÃ© sloupce");
      IupSetLanguageString("IUP_ERRORBARS", "ChybovÃ© sloupce");
      IupSetLanguageString("IUP_STEPS", "Kroky");
      IupSetLanguageString("IUP_PIE", "KolÃ¡Ä");
      IupSetLanguageString("IUP_LINESTYLE", "Styl ÄÃ¡ry:");
      IupSetLanguageString("IUP_CONTINUOUS", "SouvislÃ¡");
      IupSetLanguageString("IUP_DASHED", "ÄŒÃ¡rkovanÃ¡");
      IupSetLanguageString("IUP_DOTTED", "TeÄkovanÃ¡");
      IupSetLanguageString("IUP_DASH_DOT", "ÄŒÃ¡rka, teÄka");
      IupSetLanguageString("IUP_DASH_DOT_DOT", "ÄŒÃ¡rka, teÄka, teÄka");
      IupSetLanguageString("IUP_LINEWIDTH", "Å Ã­Å™ka ÄÃ¡ry:");
      IupSetLanguageString("IUP_MARKSTYLE", "Styl znaÄky:");
      IupSetLanguageString("IUP_BAROUTLINE", "Obrys sloupce:");
      IupSetLanguageString("IUP_BARSPACING", "VzdÃ¡lenost mezi sloupci:");
      IupSetLanguageString("IUP_BAROUTLINECOLOR", "Barva obrysu sloupce:");
      IupSetLanguageString("IUP_PLUS", "Plus");
      IupSetLanguageString("IUP_STAR", "HvÄ›zdiÄka");
      IupSetLanguageString("IUP_CIRCLE", "KrouÅ¾ek");
      IupSetLanguageString("IUP_X", "X");
      IupSetLanguageString("IUP_MARK_BOX", "ÄŒtvereÄek");
      IupSetLanguageString("IUP_DIAMOND", "Diamant");
      IupSetLanguageString("IUP_HOLLOW_CIRCLE", "PrÃ¡zdnÃ½ krouÅ¾ek");
      IupSetLanguageString("IUP_HOLLOW_BOX", "PrÃ¡zdnÃ½ ÄtvereÄek");
      IupSetLanguageString("IUP_HOLLOW_DIAMOND", "PrÃ¡zdnÃ½ diamant");
      IupSetLanguageString("IUP_MARKSIZE", "Velikost znaÄky:");
      IupSetLanguageString("IUP_AREATRANSPARENCY", "PrÅ¯hlednost plochy:");
      IupSetLanguageString("IUP_PIERADIUS", "PolomÄ›r kolÃ¡Äe:");
      IupSetLanguageString("IUP_PIESTARTANGLE", "Ãšhel poÄÃ¡tku kolÃ¡Äe:");
      IupSetLanguageString("IUP_PIECONTOUR", "Obrys kolÃ¡Äe:");
      IupSetLanguageString("IUP_PIEHOLE", "Otvor v kolÃ¡Äi:");
      IupSetLanguageString("IUP_PIESLICELABEL", "Popis dÃ­lu kolÃ¡Äe:");
      IupSetLanguageString("IUP_PIESLICELABELPOS", "Pozice popisku dÃ­lu kolÃ¡Äe:");
      IupSetLanguageString("IUP_PERCENT", "Procenta");
      IupSetLanguageString("IUP_NONE", "Nic");

      IupSetLanguageString("IUP_CLOSE", "ZavÅ™Ã­t");

      IupSetLanguageString("IUP_BACKGROUND", "PozadÃ­");
      IupSetLanguageString("IUP_TITLE", "NÃ¡zev");
      IupSetLanguageString("IUP_LEGEND", "Legenda");
      IupSetLanguageString("IUP_LEGENDBOX", "RÃ¡meÄek legendy");
      IupSetLanguageString("IUP_BOX", "OhraniÄenÃ­");
      IupSetLanguageString("IUP_GRID", "MÅ™Ã­Å¾ka");
      IupSetLanguageString("IUP_GRIDMINOR", "SekundÃ¡rnÃ­ mÅ™Ã­Å¾ka");
      IupSetLanguageString("IUP_XAXIS", "Osa X");
      IupSetLanguageString("IUP_YAXIS", "Osa Y");
      IupSetLanguageString("IUP_AXISLABEL", "Popis osy");
      IupSetLanguageString("IUP_AXISTICKS", "DÃ­lky osy");
      IupSetLanguageString("IUP_AXISTICKSNUMBER", "ÄŒÃ­sla dÃ­lkÅ¯ osy");

      IupSetLanguageString("IUP_TEXT", "Text:");
      IupSetLanguageString("IUP_SHOW", "Zobrazit:");
      IupSetLanguageString("IUP_HORIZONTAL", "VodorovnÄ›");
      IupSetLanguageString("IUP_VERTICAL", "Svisle");

      IupSetLanguageString("IUP_CHANGESNOTAPPLIEDAPPLY", "ZmÄ›ny nebyly provedeny. ProvÃ©st?");

      IupSetLanguageString("IUP_MARGIN", "Okraj");
      IupSetLanguageString("IUP_LEFT", "LevÃ½:");
      IupSetLanguageString("IUP_RIGHT", "PravÃ½:");
      IupSetLanguageString("IUP_TOP", "NahoÅ™e:");
      IupSetLanguageString("IUP_BOTTOM", "Dole:");

      IupSetLanguageString("IUP_FONTSTYLE", "Styl pÃ­sma:");
      IupSetLanguageString("IUP_FONTSIZE", "Velikost pÃ­sma:");
      IupSetLanguageString("IUP_PLAIN", "ObyÄejnÃ©");
      IupSetLanguageString("IUP_BOLD", "TuÄnÃ©");
      IupSetLanguageString("IUP_ITALIC", "KurzÃ­va");
      IupSetLanguageString("IUP_BOLDITALIC", "TuÄnÃ¡ kurzÃ­va");

      IupSetLanguageString("IUP_POSITION", "Poloha:");
      IupSetLanguageString("IUP_POSXY", "(x,y):");
      IupSetLanguageString("IUP_TOPRIGHT", "Vpravo nahoÅ™e");
      IupSetLanguageString("IUP_TOPLEFT", "Vlevo nahoÅ™e");
      IupSetLanguageString("IUP_BOTTOMRIGHT", "Vpravo dole");
      IupSetLanguageString("IUP_BOTTOMLEFT", "Vlevo dole");
      IupSetLanguageString("IUP_BOTTOMCENTER", "Dole uprostÅ™ed");
      IupSetLanguageString("IUP_XY", "(x,y)");

      IupSetLanguageString("IUP_SHOWARROW", "Zobrazit Å¡ipky:");
      IupSetLanguageString("IUP_MIN", "Min:");
      IupSetLanguageString("IUP_MAX", "Max:");
      IupSetLanguageString("IUP_REVERSE", "ObrÃ¡cenÄ›:");
      IupSetLanguageString("IUP_CROSSORIGIN", "PoÄÃ¡tek kÅ™Ã­Å¾e:");
      IupSetLanguageString("IUP_CENTERED", "CentrovanÄ›:");

      IupSetLanguageString("IUP_SCALE", "MÄ›Å™Ã­tko:");
      IupSetLanguageString("IUP_LINEAR", "LineÃ¡rnÃ­");
      IupSetLanguageString("IUP_LOG10", "LogaritmickÃ© (zÃ¡klad 10)");
      IupSetLanguageString("IUP_LOG2", "LogaritmickÃ© (zÃ¡klad 2)");
      IupSetLanguageString("IUP_LOGN", "LogaritmickÃ© (zÃ¡klad e)");

      IupSetLanguageString("IUP_SPACING", "VzdÃ¡lenost:");
      IupSetLanguageString("IUP_MAJORSPAN", "HlavnÃ­ rozsah:");
      IupSetLanguageString("IUP_MINORDIVISION", "VedlejÅ¡Ã­ rozdÄ›lenÃ­:");
      IupSetLanguageString("IUP_SIZE", "Velikost:");
      IupSetLanguageString("IUP_MAJOR", "HlavnÃ­:");
      IupSetLanguageString("IUP_MINOR", "VedlejÅ¡Ã­:");

      IupSetLanguageString("IUP_ROTATE", "OtoÄit:");
      IupSetLanguageString("IUP_ANGLE", "Ãšhel:");

      IupSetLanguageString("IUP_VALUE", "Hodnota:");
      IupSetLanguageString("IUP_DECIMALS", "Desetiny:");
      IupSetLanguageString("IUP_FORMAT", "FormÃ¡t:");
    }
  }
}
